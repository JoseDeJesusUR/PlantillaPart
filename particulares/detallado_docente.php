...
<?
		...
		$id_tip_empleado=$row3['tipo_empleado'];
		$id_funcion=$row3['tipo_docente'];
		
		$id_especifique=$row3['asignatura1'];
		$id_espe_1=$row3['asignatura2'];
		$id_espe_2=$row3['asignatura3'];
		$id_espe_3=$row3['asignatura4'];
    ...
    <div id="Accordion1" class="Accordion" tabindex="0">
      <div class="AccordionPanel">
        ...
        <br />
            ...
            <tr>
              <td height="27" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE" class="titulos"><? echo  $id_entidom ?></td>
      ...
      <div class="AccordionPanel">
        ...
        <div class="AccordionPanelContent">
          ...
          <table width="850" border="1" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td colspan="5" align="center" bgcolor="#999999"><span class="titulos2">INFORMACION PREPARACION PROFESIONAL </span></td>
              </tr>
            <tr>
              <td width="147" align="center" bgcolor="#CCCCCC">NIVEL MAX. ESTUDIOS</td>
              <td colspan="2" align="center" bgcolor="#CCCCCC">STATUS ESTUDIOS</td>
              <td colspan="2" align="center" bgcolor="#CCCCCC">EGRESADO</td>
              </tr>
            <tr>
              ...
              <td height="36" colspan="2" align="justify" valign="top" bgcolor="#DAE4FE"  class="letra_tablas"><span class="titulos"><? echo  $id_egresado ?><br /><? echo  $id_des_egre ?></span></td>
            </tr>
            <tr>
              <td height="19" colspan="3" align="center" valign="top" bgcolor="#CCCCCC">PROFESION</td>
              <td height="19" colspan="2" align="center" valign="top" bgcolor="#CCCCCC">CEDULA</td>
              </tr>
            <tr>
              <td height="30" colspan="3" align="justify" valign="top" bgcolor="#DAE4FE"  class="letra_tablas"><span class="titulos"><? echo  $id_profesi ?></span></td>
              <td height="30" align="justify" valign="top" bgcolor="#DAE4FE"  class="letra_tablas"><span class="titulos"><? echo $id_cedula ?></span></td>
              </tr>
            <tr>
              <td height="21" colspan="3" align="center" valign="top" bgcolor="#CCCCCC">OTROS ESTUDIOS </td>
              <td height="21" colspan="2" align="center" valign="top" bgcolor="#CCCCCC">CURSOS</td>
              </tr>
            <tr>
              <td height="46" colspan="3" align="justify" valign="top" bgcolor="#DAE4FE"  class="letra_tablas"><span class="titulos"><? echo $id_otros_est ?></span></td>
              <td height="46" colspan="2" align="justify" valign="top" bgcolor="#DAE4FE"  class="letra_tablas"><span class="titulos"><? echo $id_cursos ?></span></td>
            </tr>
            </table>
          </div>
        </div>
      <div class="AccordionPanel">
        ...
        <br />
          <table width="850" border="1" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td colspan="5" align="center" bgcolor="#999999"><span class="titulos2">LABORAL</span></td>
            </tr>
            <tr>
              <td colspan="2" align="center" bgcolor="#CCCCCC">FECHA INGRESO</td>
              <td colspan="3" align="center" bgcolor="#CCCCCC">FUNCION</td>
  </tr>
            <tr>
              <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE" ><span class="titulos"><? echo  $id_ing_plantel ?></span></td>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#DAE4FE"><span class="titulos"><? echo  $id_funcion ?><br />
              </span></td>
            </tr>
            <tr>
              <td height="28" colspan="2" align="center" valign="middle" bgcolor="#CCCCCC" >ASIGNATURA 1</td>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#CCCCCC">ASIGNATURA 2</td>
            </tr>
            <tr>
              <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE" ><span class="titulos"><? echo  $id_especifique ?></span></td>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#DAE4FE"><span class="titulos"><? echo  $id_espe_1 ?></span></td>
            </tr>
            <tr>
              <td height="28" colspan="2" align="center" valign="middle" bgcolor="#CCCCCC" >ASIGNATURA 3</td>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#CCCCCC">ASIGNATURA 4</td>
            </tr>
            <tr>
              <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE" ><span class="titulos"><? echo  $id_espe_2 ?></span></td>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#DAE4FE"><span class="titulos"><? echo $id_espe_3 ?></span></td>
            </tr>
            <tr>
              <td height="21" align="center" valign="top" bgcolor="#CCCCCC">HR FRENTE A GPO</td>
              <td height="21" colspan="2" align="center" valign="top" bgcolor="#CCCCCC">HR SERVICIO</td>
              <td height="21" colspan="2" align="center" valign="top" bgcolor="#CCCCCC">HR SIN GPO</td>
            </tr>
            <tr>
              <td height="27" align="center" valign="middle" bgcolor="#DAE4FE" class="titulos"><? echo  $id_hrs_gpo ?></td>
              <td height="27" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE" class="titulos"><? echo $id_hrs_serv ?></td>
              <td height="27" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE" class="titulos"><? echo  $id_hrs_sin_gpo ?></td>
            </tr>
            <tr>
              <td height="21" colspan="5" align="center" valign="top" bgcolor="#999999"><span class="titulos2">HORARIO LABORAL</span></td>
              </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#CCCCCC">DÍA </td>
              <td width="126" height="28" align="center" valign="middle" bgcolor="#CCCCCC">ENTRADA</td>
              <td width="217" height="28" align="center" valign="middle" bgcolor="#CCCCCC">SALIDA</td>
            </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#DAE4FE">LUNES</td>
              <td height="28" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_hr_lun_e ?></td>
              <td height="28" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo $id_hr_lun_s ?></td>
            </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#DAE4FE">MARTES</td>
              <td height="28" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_hr_mar_e ?></td>
              <td height="28" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_hr_mar_s ?></td>
            </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#DAE4FE">MIERCOLES</td>
              <td height="28" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_hr_mie_e ?></td>
              <td height="28" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_hr_mie_s ?></td>
            </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#DAE4FE">JUEVES</td>
              <td height="28" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_hr_jue_e ?></td>
              <td height="28" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_hr_jue_s ?></td>
            </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#DAE4FE">VIERNES</td>
              <td height="28" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_hr_vie_e ?></td>
              <td height="28" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_hr_vie_s ?></td>
            </tr>
            <tr>
              <td height="28" colspan="5" align="center" valign="middle" bgcolor="#999999"><span class="titulos2">OTRO EMPLEO</span></td>
              </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#CCCCCC">CCT 1</td>
              <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_cct1 ?></td>
              </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#CCCCCC">CCT 2</td>
              <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_cct2 ?></td>
              </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#CCCCCC">CCT 3</td>
              <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_cct3 ?></td>
              </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#CCCCCC">N° HR CCT1</td>
              <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE"><span class="titulos"><? echo  $id_hr1 ?></span></td>
              </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#CCCCCC">N° HR CCT2</td>
              <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_hr2 ?></td>
              </tr>
            <tr>
              <td height="28" colspan="3" align="center" valign="middle" bgcolor="#CCCCCC">N° HR CCT3</td>
              <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE"  class="titulos"><? echo  $id_hr3 ?></td>
            </tr>
            </table>
          <p>&nbsp;</p>
        </div>
