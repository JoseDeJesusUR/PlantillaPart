...
//import_request_variables ("P","f_");
	...
	$_SESSION['curpx']=$f_curp_dir;
	$curp_doc_dir=$_SESSION['curpx'];
	
	$_SESSION['rfcx']=$f_rfc_dir;
	$rfc_doc_dir=$_SESSION['rfcx'];
	
	$_SESSION['paternox']=$f_paterno_dir;
	$paterno_doc_dir=$_SESSION['paternox'];		

    $_SESSION['maternox']=$f_materno_dir;
	$materno_doc_dir=$_SESSION['maternox'];		
    
	$_SESSION['nombrex']=$f_nombre_dir;
	$nombre_doc_dir=$_SESSION['nombrex'];	
	
	
	$_SESSION['sexox']=$f_sexo_dir;
	$sexo_doc_dir=$_SESSION['sexox'];	

	$_SESSION['fecha_nacx']=$f_fecha_nac_dir;
	$fecha_nac_doc_dir=$_SESSION['fecha_nacx'];
	
	$_SESSION['entidad_nacx']=$f_entidad_nac_dir;
	$entidad_nacx_doc_dir=$_SESSION['entidad_nacx'];
	
	$_SESSION['estado_cx']=$f_estado_c_dir;
...
<div id="menu_stc">
  ...
  <form name="general" method="post" action="captura_prof_dir.php">
    <p>&nbsp;</p>
    <table width="661" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td colspan="4"><span class="titulos_tablas">
          <select required="required" name="entidad_dir" size="1" class="color_fondo_azul_left" id="grado3" onchange="activar(this.form)">
      ...
      <tr>
        ...
        <td colspan="4"><span class="titulos_tablas">
          <input required="required"  name="delegacion_dir" type="text" class="color_fondo_azul_left" id="delegacion_dir" size="50" maxlength="150" onkeyup="this.value=this.value.toUpperCase()"/>
        </span></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><span class="titulos_tablas">
          <input  name="colonia_dir" type="text" required="required" class="color_fondo_azul_left" id="colonia_dir" onkeyup="this.value=this.value.toUpperCase()" size="50" maxlength="150"/>
        </span></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><input required  name="domicilio_dir" type="text" class="color_fondo_azul_left" id="domicilio_dir" size="50" maxlength="150" onkeyup="this.value=this.value.toUpperCase()"/></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><input required  name="cp_dir" type="number" class="color_fondo_azul_left" id="cp_dir" size="5" maxlength="5" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="4">&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><input name="telefono_dir" type="number"  class="color_fondo_azul_left" id="telefono_dir"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
