  ...
  <div id="body_stc"><!-- InstanceBeginEditable name="body" -->
    ...
    <table width="661" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td><? echo "<span class='titulos_tablas'> $usuario </span>" ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="112"><? echo "<span class='titulos_tablas'>   $rfc_doc </span>" ?></td>
        <td width="175">&nbsp;</td>
        <td width="166">&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="3"><? echo "<span class='titulos_tablas'> $paterno_doc </span>" ?></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="3"><? echo  "<span class='titulos_tablas'>  $materno_doc </span>" ?></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="3"><?  echo  "<span class='titulos_tablas'> $nombre_doc </span>" ?></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
