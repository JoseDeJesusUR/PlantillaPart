...
<div id="menu_stc">
  ...
  <form name="general" method="post" action="captura_dom_dir.php">
    <p>&nbsp;</p>
    <table width="661" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td colspan="4"><input required="required"   name="curp_dir" type="text" class="color_fondo_azul_left" id="textfield" size="40" maxlength="18" onkeyup="this.value=this.value.toUpperCase()"/></td>
        </tr>
      <tr>
        <td colspan="5">&nbsp;</td>
      </tr>
      <tr>
        ...
        <td colspan="4"><input required="required"  name="rfc_dir" type="text" class="color_fondo_azul_left" id="textfield2" size="40" maxlength="13" onkeyup="this.value=this.value.toUpperCase()"/></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="4">&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><input required  name="paterno_dir" type="text" class="color_fondo_azul_left" id="paterno_dir" size="40" maxlength="60" onkeyup="this.value=this.value.toUpperCase()"/></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td width="123">&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><input required  name="materno_dir" type="text" class="color_fondo_azul_left" id="materno_dir" size="40" maxlength="60" onkeyup="this.value=this.value.toUpperCase()"/></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><input required  name="nombre_dir" type="text" class="color_fondo_azul_left" id="nombre_dir" size="40" maxlength="80" onkeyup="this.value=this.value.toUpperCase()"/></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="4">&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><select required="required" name="sexo_dir" size="1" class="color_fondo_azul_left" id="grado" onchange="activar(this.form)">
      ...
      <tr>
        ...
        <td colspan="4"><input name="fecha_nac_dir" type="date" class="color_fondo_azul_left" id="fecha_nac_dir"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="4">&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4" valign="top"><select required="required" name="entidad_nac_dir" size="1" class="color_fondo_azul_left" id="grado3" onchange="activar(this.form)">
          <option selected="selected" disabled="disabled"  value="" >--Seleccione--</option>
      ...
      <tr>
        ...
        <td colspan="4"><select required="required" name="estado_c_dir" size="1" class="color_fondo_azul_left" id="grado2" onchange="activar(this.form)">
