...
//import_request_variables ("P","f_");
    ...
    $_SESSION['entidadx']=$f_entidad_dir;
	$entidad_doc_dir=$_SESSION['entidadx'];
	
	$_SESSION['delegacionx']=$f_delegacion_dir;
	$delegacion_doc_dir=$_SESSION['delegacionx'];
	
	$_SESSION['coloniax']=$f_colonia_dir;
	$colonia_doc_dir=$_SESSION['coloniax'];		

    $_SESSION['domiciliox']=$f_domicilio_dir;
	$domicilio_doc_dir=$_SESSION['domiciliox'];		
    
	$_SESSION['cpx']=$f_cp_dir;
	$cp_doc_dir=$_SESSION['cpx'];	

	$_SESSION['telefonox']=$f_telefono_dir;
...
if(elemento.egresado_dir.options[elemento.egresado_dir.selectedIndex].value=="1")
  {
...
<div id="menu_stc">
  ...
  <form name="general" method="post" action="captura_lab_dir.php">
    <p>&nbsp;</p>
    <table width="621" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="5" align="center"><?  echo $entidad_doc.$delegacion_doc.$colonia_doc.$domicilio_doc.$cp_doc.$telefono_doc ?>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="4" valign="top"><select required="required" name="nivel_est_dir" size="1" class="color_fondo_azul_left" id="grado2" onchange="activar(this.form)">
      ...
      <tr>
        ...
        <td colspan="4" valign="top"><select required="required" name="status_est_dir" size="1" class="color_fondo_azul_left" id="status_est_dir" onchange="activar(this.form)">
          <option selected="selected" disabled="disabled"  value="" >--Seleccione--</option>
      ...
      <tr>
        ...
        <td colspan="4"><select name="egresado_dir" size="1" class="color_fondo_azul_left" id="egresado_dir" onChange="activar(this.form)" required="required">
          <option selected="selected" disabled="disabled"  value="" >--Seleccione--</option>
      ...
      <tr>
        <td height="4" align="right" colspan="5" id="aparece" style="display:none" ><span class="letra_folio">*</span> DESCRIBA 
          <input   name="des_egresado_dir" type="text" class="color_fondo_azul_left" id="des_egresado_dir" size="40" maxlength="100" onkeyup="this.value=this.value.toUpperCase()" onkeypress="return valida_num(event)"/></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="4">&nbsp;</td>
      ...
      <tr>
        <td><span class="letra_folio">*</span> PROFESIÓN</td>
        <td colspan="4"><input required  name="profesion_dir" type="text" class="color_fondo_azul_left" id="profesion_dir" size="40" maxlength="100" onkeyup="this.value=this.value.toUpperCase()" Placeholder=" ESCRIBA EL NOMBRE DE LA CARRERA "/></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td width="123">&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><input required  name="cedula_dir" type="text" class="color_fondo_azul_left" id="cedula_dir" size="40" maxlength="18" onkeyup="this.value=this.value.toUpperCase()"/></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><textarea name="otros_est_dir" class="color_fondo_azul_left"   cols="50" rows="5" id="otros_est_dir" placeholder=" DESCRIBA OTROS ESTUDIOS CON LOS QUE CUENTE" onkeyup="this.value=this.value.toUpperCase()"></textarea></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><label for="cursos_dir"></label>
          <textarea name="cursos_dir" class="color_fondo_azul_left"   cols="50" rows="5" id="cursos_dir" Placeholder=" DESCRIBA CURSOS" onkeyup="this.value=this.value.toUpperCase()"></textarea></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="4">&nbsp;</td>
