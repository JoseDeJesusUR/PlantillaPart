...
<?
	    ...
	    $query2="SELECT * FROM datos_aca_adm WHERE rfc='$rfc_row'"; 
	    ...
	    $query3="SELECT * FROM datos_lab_adm WHERE rfc='$rfc_row'"; 
    ...
    <div id="Accordion1" class="Accordion" tabindex="0">
      ...
      <div class="AccordionPanel">
        ...
        <div class="AccordionPanelContent">
          ...
          <table width="850" border="1" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td colspan="6" align="center" bgcolor="#999999"><span class="titulos2">INFORMACION PREPARACION PROFESIONAL </span></td>
              </tr>
            <tr>
              <td width="159" align="center" bgcolor="#CCCCCC">NIVEL MAX. ESTUDIOS</td>
              <td colspan="5" align="center" bgcolor="#CCCCCC">EGRESADO</td>
              </tr>
            <tr>
              <td height="36" align="justify" valign="top" bgcolor="#DAE4FE"  class="letra_tablas"><span class="titulos"><? echo  $id_niv_est ?></span></td>
              <td height="36" colspan="4" align="center" valign="top" bgcolor="#DAE4FE"  class="letra_tablas"><span class="titulos"><? echo  $id_egresado ?><br /><? echo  $id_des_egre ?></span></td>
              </tr>
            <tr>
              <td height="19" colspan="2" align="center" valign="top" bgcolor="#CCCCCC">PERFIL</td>
              <td width="465" height="19" align="center" valign="top" bgcolor="#CCCCCC">OTROS ESTUDIOS </td>
              <td width="217" height="19" align="center" valign="top" bgcolor="#CCCCCC">CURSOS</td>
            </tr>
            <tr>
              <td height="30" colspan="2" align="justify" valign="top" bgcolor="#DAE4FE"  class="letra_tablas"><span class="titulos"><? echo  $id_perfil ?></span></td>
              <td height="30" align="justify" valign="top" bgcolor="#DAE4FE"  class="letra_tablas"><span class="titulos"><? echo $id_otros_est ?></span></td>
              <td height="30" align="justify" valign="top" bgcolor="#DAE4FE"  class="letra_tablas"><span class="titulos"><? echo $id_cursos ?></span></td>
            </tr>
            </table>
          </div>
        </div>
      <div class="AccordionPanel">
        ...
        <br />
          <table width="850" border="1" align="center" cellpadding="0" cellspacing="0">
<tr>
  <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE"><table width="850" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="4" align="center" bgcolor="#999999"><span class="titulos2">LABORAL</span></td>
    </tr>
    <tr>
      <td width="314" align="center" bgcolor="#CCCCCC">FECHA INGRESO</td>
    ...
    <tr>
      ...
      <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE"><span class="titulos"><? echo  $id_funcion ?><br />
        <? echo  $id_especifique ?></span></td>
      </tr>
    <tr>
      <td height="21" colspan="4" align="center" valign="top" bgcolor="#999999"><span class="titulos2">HORARIO LABORAL</span></td>
    </tr>
    <tr>
      <td height="28" colspan="2" align="center" valign="middle" bgcolor="#CCCCCC">DÍA </td>
      <td width="220" height="28" align="center" valign="middle" bgcolor="#CCCCCC">ENTRADA</td>
      <td width="123" height="28" align="center" valign="middle" bgcolor="#CCCCCC">SALIDA</td>
    </tr>
    <tr>
      <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE">LUNES</td>
    ...
    <tr>
      <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE">MARTES</td>
    ...
    <tr>
      <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE">MIERCOLES</td>
    ...
    <tr>
      <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE">JUEVES</td>
    ...
    <tr>
      <td height="28" colspan="2" align="center" valign="middle" bgcolor="#DAE4FE">VIERNES</td>
  ...
  </table>    <span class="titulos"></span></td>
</tr>
</table>
          <p>&nbsp;</p>
        </div>
