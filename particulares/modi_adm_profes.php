...
<div id="menu_stc">
  ...
  <div id="body_stc"><!-- InstanceBeginEditable name="body" -->
    <form name="general" method="post" action="update_adm_profe.php">
      <div class="col-2">
      <label>
      NIVEL MAX. ESTUDIO
  ...
  <div class="col-2">
      <label>
      DESCRIPCIÓN EGRESADO 
      <input name="egresado" id="egresado" tabindex="1" onkeyup="this.value=this.value.toUpperCase()" value="<? echo  $id_egresado ?>">
    </label>
  </div>
   ...
   <div class="col-2">
    <label>
      PERFIL
      <input  id="des_egresado" name="des_egresado" tabindex="1" onkeyup="this.value=this.value.toUpperCase()" value="<? echo  $id_perfil ?>">
    </label>
