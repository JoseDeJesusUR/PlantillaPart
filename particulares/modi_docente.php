  ...
  <div id="body_stc"><!-- InstanceBeginEditable name="body" -->
   <form name="general" method="post" action="captura_dom.php">
    ...
    <table width="93%"  border="1" cellpadding="0" cellspacing="0" align="center" class="paleBlueRows">
      <tr>
       <td width="7%" align="center" bgcolor="#00FFFF" class="titulos_tablas">RFC</td>
       <td width="35%" align="center" bgcolor="#00FFFF"><span class="titulos_tablas">DOCENTE</span></td>
       <td width="14%" align="center" bgcolor="#00FFFF"><span class="titulos_tablas">PERSONALES</span></td>
       <td width="17%" align="center" bgcolor="#00FFFF"><span class="titulos_tablas">PROFESIONALES</span></td>
       <td width="13%" align="center" bgcolor="#00FFFF"><span class="titulos_tablas">LABOLARES</span></td>
       <td width="14%" align="center" bgcolor="#00FFFF"><span class="titulos_tablas">ELIMINAR</span></td>
      </tr>
      <?
  /*
	...
	$query="SELECT *
           FROM datos_per
           WHERE cct ='$usuario' AND tipo_personal='DOCENTE' AND status_captura='1' order by rfc;";
...
?>
      <tr>
        ...
        <td align="center"><a href="modi_docente_personales.php?rfc_do=<?=$row["rfc"]?>" target="_parent"><i style="font-size:24px" class="fa">&#xf2bc;</i></a></td>
        <td align="center"><a href="modi_docente_profes.php?rfc_do=<?=$row["rfc"]?>" target="_parent"><i style="font-size:24px" class="fa">&#xf19d;</i></a></td>
        <td align="center"><a href="modi_docente_laborales.php?rfc_do=<?=$row["rfc"]?>" target="_parent"><i style="font-size:24px" class="fa">&#xf044;</i></a></td>
