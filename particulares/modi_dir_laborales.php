...
<div id="menu_stc">
  ...
  <div id="body_stc"><!-- InstanceBeginEditable name="body" -->
    <form name="general" method="post" action="update_dir_lab.php">
  ...
  <div class="col-3">
     ...
     <label>
      FUNCIÓN
        ...
        <option ><? echo $id_funcion ?></option>
          <option value="DIRECTOR(A) TECNICO">DIRECTOR(A) TÉCNICO</option>
          <option value="SUBDIRECTOR(A) TECNICO">SUBDIRECTOR(A) TÉCNICO</option>
...
<div class="col-3">
  ...
  <label>
      ...
      <input  id="especifique" name="especifique" tabindex="1" onkeyup="this.value=this.value.toUpperCase()"
      value="<? echo  $id_especifique ?>">
    </label>
