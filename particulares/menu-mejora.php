...
<div id="menu_stc">
  ...
  <p class="titulos2">&nbsp;</p>
  <p class="titulos2">&nbsp;</p>
  <form name="general" method="post" action="supervision_mejo1.php">
  
  <table width="674" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="674" height="34" align="center" bgcolor="#FF7F00" class="titulos_menu">SUPERVISIÓN Y MEJORA DE LOS APRENDIZAJES</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><span class="letra_tablas">Seleccione el Trimetres que desea capturar:</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><select required name="trimestre1" size="1" class="color_fondo_azul_left" id="trimestre1" >
        <option selected disabled value="">--Seleccione--</option>
        <option value="1">1er Trimestre</option>
        <option value="2">2do Trimestre</option>
        <option value="3">3er Trimestre</option>
        <option value="4">4to Trimestre</option>
      </select> <input type="submit" name="guardar" id="guardar" value="Iniciar Captura" />
        </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
