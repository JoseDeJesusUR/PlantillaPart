...
//import_request_variables ("P","f_");
	...
	$_SESSION['OK_tabl_B1']=$f_tabl_B1;
	///
	$tabla_B1=$_SESSION['OK_tabl_B1'];
	///
	$_SESSION['OK_tabl_B2']=$f_tabl_B2;
	///
	$tabla_B2=$_SESSION['OK_tabl_B2'];
	///
   ...
   <p>&nbsp;</p>
    ...
    <p>&nbsp;</p>
      <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center"><p>&nbsp;</p>
          <p class="subtitlesbig_gray">LOS DATOS SE GUARDARON CORRECTAMENTE</p></td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
