...
//import_request_variables ("P","f_");
	...
	$_SESSION['curpx']=$f_curp_adm;
	$curp_doc_adm=$_SESSION['curpx'];
	
	$_SESSION['rfcx']=$f_rfc_adm;
	$rfc_doc_adm=$_SESSION['rfcx'];
	
	$_SESSION['paternox']=$f_paterno_adm;
	$paterno_doc_adm=$_SESSION['paternox'];		

    $_SESSION['maternox']=$f_materno_adm;
	$materno_doc_adm=$_SESSION['maternox'];		
    
	$_SESSION['nombrex']=$f_nombre_adm;
	$nombre_doc_adm=$_SESSION['nombrex'];	
	
	
	$_SESSION['sexox']=$f_sexo_adm;
	$sexo_doc_adm=$_SESSION['sexox'];	
                                 
	$_SESSION['fecha_nacx']=$f_fecha_nac_adm;
	$fecha_nac_doc_adm=$_SESSION['fecha_nacx'];
	                     
						 						 
	$_SESSION['entidad_nacx']=$f_entidad_nac_adm;
	$entidad_nacx_doc_adm=$_SESSION['entidad_nacx'];
	
	$_SESSION['estado_cx']=$f_estado_c_adm;
...
<div id="menu_stc">
  ...
  <form name="general" method="post" action="captura_prof_adm.php">
    <p>&nbsp;</p>
    <table width="661" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="37" colspan="5" align="center"><p class="vinculo_error">DOMICILIO<br>
      ...
      <tr>
        ...
        <td colspan="4"><span class="titulos_tablas">
          <select required="required" name="entidad_adm" size="1" class="color_fondo_azul_left" id="grado3" onchange="activar(this.form)">
      ...
      <tr>
        <td><span class="letra_folio">*</span> DELEGACIÓN </td>
        <td colspan="4"><span class="titulos_tablas">
          <input required="required"  name="delegacion_adm" type="text" class="color_fondo_azul_left" id="delegacion_adm" size="50" maxlength="150" onkeyup="this.value=this.value.toUpperCase()"/>
        </span></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><span class="titulos_tablas">
          <input  name="colonia_adm" type="text" required="required" class="color_fondo_azul_left" id="colonia_adm" onkeyup="this.value=this.value.toUpperCase()" size="50" maxlength="150"/>
        </span></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><input required  name="domicilio_adm" type="text" class="color_fondo_azul_left" id="domicilio_adm" size="50" maxlength="150" onkeyup="this.value=this.value.toUpperCase()"/></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><input required  name="cp_adm" type="number" class="color_fondo_azul_left" id="cp_adm" size="10" maxlength="5" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="4">&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="4"><input name="telefono_adm" type="number"  class="color_fondo_azul_left" id="telefono_adm"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
