...
/////////////////////////////pagina 1	
    ...
    $pdf->Cell(0,25,'PLANTILLA DE PERSONAL ADMINISTRATIVO Y DE APOYO CCT: '."$usuario_doc" ,0,1,"C");
	$pdf->Ln(0);

	$pdf->SetWidths(array(34,20, 35, 35, 34, 25, 65));
	...
	WHERE cct = '$usuario_doc' and tipo_personal='ADM-APOYO' AND status_captura='1' order by rfc";
