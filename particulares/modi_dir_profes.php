...
<?
		...
		$id_profesion=$row2['profesion'];  
		
		$id_ced_prof=$row2['ced_prof'];
...
<div id="menu_stc">
  ...
  <div id="body_stc"><!-- InstanceBeginEditable name="body" -->
    <form name="general" method="post" action="update_dir_profe.php">
      <div class="col-2">
      <label>
      NIVEL MAX. ESTUDIO
  ...
  <div class="col-2">
    <label>
      CARRERA
      <input  id="carrera" name="carrera" tabindex="1" onkeyup="this.value=this.value.toUpperCase()" value="<? echo  $id_profesion  ?>">
    </label>
  </div>
  ...
  <div class="col-2">
    <label>
    CEDULA PROFESIONAL
      <input  id="cedula" name="cedula" tabindex="1" onkeyup="this.value=this.value.toUpperCase()" value="<? echo  $id_ced_prof  ?>">
    </label>
