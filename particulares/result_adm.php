  ...
  <div id="body_stc"><!-- InstanceBeginEditable name="body" -->
   ...
   <form name="general" method="post" action="captura_dom.php">
    ...
    <table width="79%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="33%">&nbsp;</td>
        <td width="47%" align="right"><span class="titulos_tablas">PLANTILLA ADMINISTRATIVA</span></td>
        <td width="20%" rowspan="3" align="center"><a href="pdf/reporte_adm.php?rfc_do=<?=$usuario?>" target="_blank"><img src="img/pdf.png" width="150" height="53" /></a></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
    ...
    <table width="80%"  border="1" cellpadding="0" cellspacing="0" align="center" class="paleBlueRows">
      <tr>
       <td width="10%" align="center" bgcolor="#D4DF55" class="titulos_tablas">RFC</td>
       <td width="50%" align="center" bgcolor="#D4DF55"><span class="titulos_tablas">ADMINISTRATIVO Y APOYO</span></td>
       <td width="23%" align="center" bgcolor="#D4DF55"><span class="titulos_tablas">FECHA ACTUALIZACION </span></td>
       <td width="17%" align="center" bgcolor="#D4DF55"><span class="titulos_tablas">CONSULTAR</span></td>
      </tr>
      <?
  /*
...
?>
      <tr>
        ...
        <td align="center"><i style="font-size:24px" class="fa">&#xf06e;</i><a href="detallado_adm.php?rfc_do=<?=$row["rfc"]?>" target="_parent"> VER</a></td>
      </tr>
      <tr>
        <?   
	 }
