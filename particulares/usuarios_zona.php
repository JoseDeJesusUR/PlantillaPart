...
<div id="menu_stc">
  ...
  <div id="body_stc"><!-- InstanceBeginEditable name="body" -->
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <table width=87%  border="1" cellpadding="0" cellspacing="0" align="center">
      <tr>  
     
    <td width=20% align="center" bgcolor="#7DB1FF" class="titulos_tablas">CCT</td>					
    <td width=80% align="center" bgcolor="#7DB1FF"><span class="titulos_tablas">NOMBRE ESCUELA</span>    </tr>
  ...
  /*
	...
	$query_cct="SELECT *
           FROM datos_cct
           WHERE cct_insp='$usuario' order by cct;";
          
		 
		   
    $result_cct= mysql_query($query_cct) or die (mysql_error());
    while ($row = @mysql_fetch_array($result_cct)){
	
		 
		 
		 
		$cct_gral=$row['cct'];
		$cct_nombre=$row['nombre'];
...
?>
  ...
  <tr> 
    ...
    <td align="center"><? echo $cct_nombre ?></td>
      <tr>
<?   
	 }
