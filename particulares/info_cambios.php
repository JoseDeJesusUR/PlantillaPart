...
<div id="menu_stc">
  ...
  <table width=90%  border="1" cellpadding="0" cellspacing="0" align="center">
    ...
    <td width=15% align="center" bgcolor="#7DB1FF" class="titulos_tablas">CCT</td>					
    <td width=25% align="center" bgcolor="#7DB1FF"><span class="titulos_tablas">CURP</span>
    <td width=40% align="center" bgcolor="#7DB1FF"><p class="titulos_tablas">NOMBRE</p>
    <td width=20% align="center" bgcolor="#7DB1FF"><span class="titulos_tablas">FECHA CAMBIO</span>        
    </tr>
  ...
  /*
    ...
    while ($row = @mysql_fetch_array($result)){
		  ...
		  $cct_camb=$row['cct'];
		  $curp_camb=$row['curp'];
		  $pat_camb=$row['paterno'];
		  $mat_camb=$row['materno'];
		  $nom_camb=$row['nombre'];
		  $fecha_camb=$row['fecha'];

		  $espacio=" ";	
		  $nombre_cambio="$pat_camb$espacio$mat_camb$espacio$nom_camb";  
...
?>
  ...
  <tr> 
    ...
    <td align="center"><? echo $cct_camb ?></td>
    <td align="center"><? echo $curp_camb ?></td>
    <td align="center"><? echo $nombre_cambio ?></td>
    <td align=center><? echo $fecha_camb ?></td>
    <tr>
<?   
	 }
